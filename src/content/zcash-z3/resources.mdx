...
ahead of the NU6.3 ("Ironwood") network upgrade that it does not support. Zcash
consensus now
runs on Zebra. See the
[Zcashd End-of-Life notice](https://zcash.github.io/zcash/user/end-of-life.html).

Zcash Engineers will be posting updates on this website:
